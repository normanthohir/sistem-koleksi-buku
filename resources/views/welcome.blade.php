...
<head>
    ...
    <title>contoh navbar moderen</title>
...
{{-- <body class="bg-gray-100">
    ...
    <nav class="bg-slate-200 p-3 border-gray-200 shadow-md fixed top-0 w-full z-10">
        <div class="flex justify-end items-end">
            <!-- Drawer toggle button - Only visible on mobile -->
            <button
                class="block  md:hidden text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            ...
            <div class="hidden md:flex space-x-4 pr-20">
                <a href="#"
                    class="text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg px-3 py-2">Beranda</a>
                <a href="#"
                    class="text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg px-3 py-2">About</a>
            </div>
        </div>
    </nav>
